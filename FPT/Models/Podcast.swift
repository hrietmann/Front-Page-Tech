...
struct Podcast: Identifiable {
    ...
    static let list = [
        Podcast(title: "Jon Prosser RUINED WWDC...",
        ...
        Podcast(title: "We got our new iMacs and we have THOUGHTS...",
                image: "Podcast 3", date: Date.string("25-05-2021"),
                description: "Genius Bar",
                duration: 1 * 60 * 60 + 24 * 60 + 5),
        
        Podcast(title: "Exclusive: Apple's SECRET PLAN for AirPods",
        ...
        Podcast(title: "The RETURN of the MacBook...",
        ...
        Podcast(title: "Sam WRECKED His Tesla...",
                image: "Podcast 6",
        ...
        Podcast(title: "We changed our minds about the iMac...",
        ...
        Podcast(title: "This is NOT the iMac we wanted!",
        ...
        Podcast(title: "BONUS EPISODE: The Apple April Event is official! Never doubt The Good Good.",
